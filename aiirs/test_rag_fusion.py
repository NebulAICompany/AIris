...
import sys
import os
sys.path.append(os.path.join(os.path.dirname(__file__), 'aiiris_backend'))

from aiiris_backend.retrieval.rag_fusion import generate_fusion_queries, reciprocal_rank_fusion, retrieve_with_fusion
...
def test_reciprocal_rank_fusion():
    ...
    mock_results = {
        "climate change effects": [
            {"content": "Climate change causes global warming", "metadata": {"file_name": "doc1.pdf"}, "score": 0.9},
            {"content": "Rising sea levels due to climate change", "metadata": {"file_name": "doc2.pdf"}, "score": 0.8},
            {"content": "Economic impact of climate change", "metadata": {"file_name": "doc3.pdf"}, "score": 0.7}
        ],
        "global warming impacts": [
            {"content": "Economic impact of climate change", "metadata": {"file_name": "doc3.pdf"}, "score": 0.85},
            {"content": "Climate change causes global warming", "metadata": {"file_name": "doc1.pdf"}, "score": 0.75},
            {"content": "Environmental effects of warming", "metadata": {"file_name": "doc4.pdf"}, "score": 0.65}
        ],
        "environmental changes": [
            {"content": "Rising sea levels due to climate change", "metadata": {"file_name": "doc2.pdf"}, "score": 0.8},
            {"content": "Environmental effects of warming", "metadata": {"file_name": "doc4.pdf"}, "score": 0.7},
            {"content": "Biodiversity loss from climate change", "metadata": {"file_name": "doc5.pdf"}, "score": 0.6}
        ]
    }
    ...
    try:
        ...
        for i, result in enumerate(fused_results[:5], 1):
            print(f"   {i}. Score: {result['fusion_score']:.4f} - {result['content'][:50]}...")
    except Exception as e:
