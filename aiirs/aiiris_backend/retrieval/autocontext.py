...
class AutoContextProcessor:
    ...
    def __init__(self, 
        ...
        self.document_title_guidance = document_title_guidance or "Generate a concise, descriptive title for this document"
        self.document_summary_guidance = document_summary_guidance or "Provide a brief summary of the document's main content and purpose"
        self.section_summary_guidance = section_summary_guidance or "Summarize the key points of this section"
        
    async def generate_document_title(self, document_text: str, existing_title: str = None) -> str:
        """
...
Generated title:"""
    ...
    async def generate_document_summary(self, document_text: str, document_title: str) -> str:
        """
...
Belge özeti:"""
    ...
    async def generate_section_summary(self, section_title: str, section_content: str, document_title: str) -> str:
        """
...
Bölüm özeti:"""
            ...
            logger.info(f"Generated summary for section '{section_title}': {summary[:50]}...")
            return summary
    ...
    def find_chunk_section(self, chunk_text: str, sections: List[Dict[str, Any]], document_lines: List[str]) -> Optional[Dict[str, Any]]:
        """
    ...
    def create_contextual_header(self, 
                               chunk_text: str,
                               document_title: str,
    ...
    async def process_document_chunks(self, 
                                    ...
                                    file_name: str = None) -> List[Document]:
        """
        ...
        for i, chunk in enumerate(chunks):
            try:
                ...
                section_info = self.find_chunk_section(chunk.page_content, sections, document_lines)
        ...
        logger.info(f"Successfully processed {len(processed_chunks)} chunks with AutoContext")
        return processed_chunks

# Global AutoContext processor instance
autocontext_processor = AutoContextProcessor()

async def apply_autocontext(chunks: List[Document], 
                          document_title: str = None,
                          file_name: str = None,
                          enabled: bool = True) -> List[Document]:
    """
