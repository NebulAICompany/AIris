    ...
    this.translations = {
      en: {
        ...
        balanceCalendar: {
          ...
          clickRefreshToLoad: "Click the refresh button to load balance data",
      ...
      tr: {
        ...
        balanceCalendar: {
          ...
          noDataLoaded: "Veri Yüklenmedi",
          clickRefreshToLoad: "Bakiye verilerini yüklemek için yenile butonuna tıklayın",
